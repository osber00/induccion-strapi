...
export interface ApiEstudianteEstudiante extends Schema.CollectionType {
  ...
  attributes: {
    ...
    identificacion: Attribute.String & Attribute.Required & Attribute.Unique;
    telefono: Attribute.String & Attribute.Required;
    acudiente: Attribute.String & Attribute.Required;
    contacto_acudiente: Attribute.String & Attribute.Required;
    programa: Attribute.Relation<
      'api::estudiante.estudiante',
      'manyToOne',
      'api::programa.programa'
    >;
    modalidad: Attribute.Relation<
      'api::estudiante.estudiante',
      'manyToOne',
      'api::modalidad.modalidad'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiModalidadModalidad extends Schema.CollectionType {
  ...
  attributes: {
    nombre: Attribute.String & Attribute.Required;
    slug: Attribute.UID<'api::modalidad.modalidad', 'nombre'> &
      Attribute.Required;
...
export interface ApiProgramaPrograma extends Schema.CollectionType {
  ...
  attributes: {
    nombre: Attribute.String & Attribute.Required;
    slug: Attribute.UID<'api::programa.programa', 'nombre'> &
      Attribute.Required;
    estudiantes: Attribute.Relation<
      'api::programa.programa',
      'oneToMany',
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::modalidad.modalidad': ApiModalidadModalidad;
